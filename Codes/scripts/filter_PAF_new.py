...
paf_folder = '/mnt/DATA_2/Biovigilance/P_viticola/Fastq_demux/filteredPAFs'
out_file = '/mnt/DATA_2/Biovigilance/P_viticola/Fastq_demux/otu_table_P.viticola_2016_filtered.csv'
