...
Moreover, reads with a block lenght alignment < 350 pb will be also removed
by default. In our test dataset, 25% of the hits in the raw PAF file had a
block length < 350 p.b.
...
def filterPAF(fileRoute, blockLimit = 350):
    """
